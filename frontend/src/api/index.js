...
export const archiveAccounts = (emails) => post('/api/accounts/archive', { emails })
export const unarchiveAccounts = (emails) => post('/api/accounts/unarchive', { emails })
export const resetAccountsToImported = (emails) => post('/api/accounts/reset-imported', { emails })
